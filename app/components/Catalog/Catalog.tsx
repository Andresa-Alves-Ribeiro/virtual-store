...
export default function Catalog({ category }: categorySelected) {
    ...
    return (
        <section id="catalog" className="w-full bg-zinc-900 px-4 py-8 sm:px-6 sm:py-10 md:px-10 md:py-12">
            ...
            <div className="mx-auto mt-6 grid w-full max-w-7xl grid-cols-1 gap-4 sm:mt-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
